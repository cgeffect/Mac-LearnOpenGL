...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader(FileSystem::getPath("LearnOpenGL-09/LearnOpenGL/6.1.coordinate_systems.vs").c_str(), FileSystem::getPath("LearnOpenGL-09/LearnOpenGL/6.1.coordinate_systems.fs").c_str());
